...
?>
    ...
    <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyCqyQucrB0MzSqxh-AS0iBAnqRec7MQwto">
    </script>
    ...
    <script>
        ...
        var myOptions = {
            zoom: 7,
            center: new google.maps.LatLng(6.785277702704765, 80.11392854687506),
            mapTypeId: 'roadmap'
        };
        ...
        var addMarker = google.maps.event.addListener(map, 'click', function(e) {
            ...
            var marker = new google.maps.Marker({
                ...
                "                <td><input type='text'  id='manual_description' placeholder='Description'></textarea></td></tr>\n" +
