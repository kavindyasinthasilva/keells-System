			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="form-wizard.php">Add New Product</a></li>
							<li><a href="form-wizard.php">Add New Invoice</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<ul class="submenu">
							<li><a href="basic-table.html">Customer Details</a></li>
							<li><a href="osertable.php">Oder Details</a>
							<li><a href="osertable.php">States Complate Details</a>
						
							
							
							<li><a href="datatable.html">Admin Details</a></li>
							<li><a href="datatable.html">Invoice Details</a></li>
